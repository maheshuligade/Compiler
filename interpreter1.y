...
Slist:Slist Stmt 	{		/*$$=(struct tnode *)malloc(sizeof(struct tnode));
							...
							$$->ptr1=$2;
							$$->ptr2=Make_Node(TYPE_VOID,Node_Type_DUMMY,$2->value,NULL,$1,$2,NULL,NULL);
							evaluate($$);
							/*cout<<endl;
							for (i = 0; i <=26; i++)	
							{
...
Stmt:ID EQUAL expr SEMICOLON		{ 
										...
										$$->ptr1=Make_Node(TYPE_VOID,Node_Type_ASSIGNMENT,'=',$1->NAME,$1,$3,NULL,NULL);
										//cout<<"ID"<<$$->ptr1->NAME<<endl;
									}
	|READ'('ID')'	SEMICOLON  		{
										$$=Make_Node(TYPE_VOID,Node_Type_DUMMY,$3->value,NULL,NULL,NULL,NULL,NULL);
										$$->ptr1=Make_Node(TYPE_VOID,Node_Type_READ,'r',NULL,$3,NULL,NULL,NULL);
									}
	|WRITE'('expr')' SEMICOLON		{
										$$=Make_Node(TYPE_VOID,Node_Type_DUMMY,$3->value,NULL,NULL,NULL,NULL,NULL);
										$$->ptr1=Make_Node(TYPE_VOID,Node_Type_WRITE,'W',NULL,$3,NULL,NULL,NULL);
									}
	|IF '('expr')'THEN Slist ENDIF SEMICOLON{
												$$=Make_Node(TYPE_VOID,Node_Type_DUMMY,$3->value,NULL,NULL,NULL,NULL,NULL);
												$$->ptr1=Make_Node(TYPE_VOID,Node_Type_IF,'i',NULL,$3,$6,NULL,NULL);
											}
...
expr:expr PLUS expr		{	//cout<<"In PLUS"<<endl;
							$$=Make_Node(TYPE_VOID,Node_Type_DUMMY,$2->value,NULL,NULL,NULL,NULL,NULL);
							//cout<<"+"<<endl;
							$$->ptr2=NULL;
							$$->ptr1=Make_Node(TYPE_VOID,Node_Type_PLUS,'+',NULL,$1,$3,NULL,NULL);
						}
	|expr MINUS expr	{
							$$=Make_Node(TYPE_VOID,Node_Type_DUMMY,$2->value,NULL,NULL,NULL,NULL,NULL);
							$$->ptr2=NULL;
